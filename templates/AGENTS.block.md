...
- **Diet:** answer-first; grep-before-read; batch tools; minimize turns.
- **Zones:** `[PLAN]`/`[ARCH]` = premium depth; `[GIT]`/`[CMD]`/`[PKG]` = terse ops.
- **Ignores:** respect `.cursorignore` / `.claudeignore` / `.codexignore` boundaries.
